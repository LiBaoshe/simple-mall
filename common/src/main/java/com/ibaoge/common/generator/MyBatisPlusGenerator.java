package com.ibaoge.common.generator;
...
public class MyBatisPlusGenerator {
    //作者名
    private static final String AUTHOR = "baoge";
    //表table的前缀，不加到生成的类名中
    private static final String PREFIX = "t_";
    
    private static final String JDBC_URL = "jdbc:mysql://192.168.10.100:3306/db_mall?useUnicode=true&characterEncoding=UTF-8" +
            "&useSSL=false&zeroDateTimeBehavior=convertToNull&tinyInt1isBit=false";
    ...
    public static void generate(String moduleName, String... tables){
        ...
        //自定义配置
        cofnigCustom(generator, moduleName);
        //模版引擎配置
    ...
    private static void configDataSource(AutoGenerator generator){
        ...
        dataSourceConfig.setTypeConvert(new MySqlTypeConvert(){
            ...
            public IColumnType processTypeConvert(GlobalConfig globalConfig, String fieldType) {
                // 将 tinyint 转换成 int
                if(fieldType.toLowerCase(Locale.ROOT).contains("tinyint")){
     ...
     * @date 2021/2/8 13:28
     */
    private static void configGlobal(AutoGenerator generator, String moduleName) {
        // 全局配置
        GlobalConfig globalConfig = new GlobalConfig();
        //生成文件输出存放路径 = 当前项目路径 + 想存放到项目中的路径
        String fileOutputPatch = getModuleDir(moduleName).concat("/src/main/java");
...
//        globalConfig.setSwagger2(true);
     ...
     * @date 2021/2/8 13:34
     */
    private static void configStrategy(AutoGenerator generator, String[] tables) {
        // 策略配置
...
//        generator.setTemplateEngine(new VelocityTemplateEngine());
     ...
     * @date 2021/2/8 13:55
     */
    private static void cofnigCustom(AutoGenerator generator, String moduleName) {
        // 自定义配置
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return getModuleDir(moduleName).concat("/src/main/resources/mapper/")
    ...
    private static String getModuleDir(String moduleName){
        return System.getProperty("user.dir").concat("/").concat(moduleName);
    }
    
//    ————————————————
//    版权声明：本文为CSDN博主「min开发」的原创文章，遵循CC 4.0 BY-SA版权协议，转载请附上原文出处链接及本声明。
//    原文链接：https://blog.csdn.net/liu649983697/article/details/113930493
}
